...
from app.models import BusinessApiKey
...
def list_keys(user: CurrentUserDep, session: SessionDep) -> list[BusinessApiKey]:
...
def revoke_key(key_id: int, user: CurrentUserDep, session: SessionDep) -> BusinessApiKey:
